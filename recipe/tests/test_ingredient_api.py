...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_creating_ingredient_succesful(self):
    ...
    def test_retrieve_ingredients_assigned_to_recipes(self):
        """Test filtering ingredients bu those assigned to recipes"""
    ...
    def test_delete_ingredient(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user, name='Coconut')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Chicken')

        url = detail_ingredient_url(ingredient1.id)
